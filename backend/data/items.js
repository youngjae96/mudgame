...
const ITEM_POOL = [
  ...
  { name: ITEM_NAME_SKY_SWORD, description: '하늘의 힘이 깃든 검', atk: 45, str: 6, dex: 4, type: ITEM_TYPE.WEAPON, price: 8000 },
  { name: ITEM_NAME_SKY_ARMOR, description: '하늘의 힘이 깃든 갑옷', def: 35, str: 4, dex: 3, type: ITEM_TYPE.ARMOR, price: 9000 },
];
